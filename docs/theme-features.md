...
菜单项支持通过 Halo 元数据配置 Iconify SVG 图标。未配置图标时保留默认文字、序号和层级提示；配置后 Header、移动端菜单和页脚菜单会统一展示。
...
- 追番：`bangumis.html`
- Steam：`steam.html`
- 项目集列表与详情：`portfolio.html`、`portfolio-detail.html`
- 产品商城列表与详情：`product.html`、`product-detail.html`
